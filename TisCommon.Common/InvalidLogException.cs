...
namespace TiS.Core.TisCommon
{
    ...
    public class InvalidLogException : Exception
    {
        ...
        public InvalidLogException(string message, string logName, Exception innerException):base(message, innerException)
        {
        ...
        /// <param name="message">The error message.</param>
        /// <param name="logName">The name of the log.</param>
        public InvalidLogException(string message, string logName): this(message, logName, null)
        {
        }
